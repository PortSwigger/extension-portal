...
# Get the script path
SCRIPT_PATH = Path(__file__).parent.parent / 'resolve_source_repo.py'

# Test cases
tests = [
    {
        'name': 'Fork resolves to its source repository (hackvertor)',
        'env': {
            'URL': 'https://github.com/PortSwigger/hackvertor'
        },
        'expect_success': True,
        'expected_output': 'normalized_url=https://github.com/'
    },
    {
        'name': 'Pull request URL resolves to source repository (hackvertor)',
        'env': {
            'URL': 'https://github.com/PortSwigger/hackvertor/pull/1'
        },
        'expect_success': True,
        'expected_output': 'normalized_url=https://github.com/'
    },
    {
        'name': 'PortSwigger-owned repository resolves to itself (turbo-intruder)',
        'env': {
    ...
    },
    {
        ...
        'env': {
            'URL': 'https://github.com/PortSwigger/this-repo-definitely-does-not-exist-123456789/pull/1'
        },
...
def main():
    """Run all tests."""
    print('Running source repository resolution tests...\n')
